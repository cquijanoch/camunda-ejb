...
public class ValidarUsuarioController {
	...
	@POST
	public ResponseMessage<GetTaskDto<RequerimientoDigaDto>> saveUsuario(
		...
		variables.put("aprobado", body.getAprobado());
	...
	@GET
	public ResponseMessage<GetTaskDto<RequerimientoDigaDto>> getAllUsuariosDIGA() {
